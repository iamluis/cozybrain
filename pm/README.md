...
| #    | Slug                       | Status        |
|------|----------------------------|---------------|
| 0001 | bootstrap-rails-app        | 🔴 not started |
...
| 0006 | folder-sync                | 🔴 not started |
| 0007 | invoice-flow               | 🔴 not started |
| 0008 | weekly-pulse               | 🔴 not started |
| 0009 | needs-review               | 🔴 not started |
| 0010 | deployment-kamal           | 🔴 not started |
