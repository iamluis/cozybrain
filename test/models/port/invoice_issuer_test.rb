...
class Port::InvoiceIssuerTest < ActiveSupport::TestCase
  ...
  test "assert_input! rejects missing keys" do
    assert_raises(Runtime::AssertionError) { Port::InvoiceIssuer.assert_input!(valid_input.except("client_name")) }
  end

  test "assert_input! rejects wrong types" do
    bad = valid_input.merge("period_month" => "5") # string instead of Integer
